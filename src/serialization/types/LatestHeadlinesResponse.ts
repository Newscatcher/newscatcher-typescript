...
export const LatestHeadlinesResponse: core.serialization.ObjectSchema<
    serializers.LatestHeadlinesResponse.Raw,
...
export declare namespace LatestHeadlinesResponse {
    interface Raw {
        status?: string | null;
        total_hits: number;
        page: number;
