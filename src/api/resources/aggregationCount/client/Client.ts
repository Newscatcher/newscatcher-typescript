...
export declare namespace AggregationCountClient {
 ...
 */
export class AggregationCountClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<AggregationCountClient.Options>;

    constructor(options: AggregationCountClient.Options) {
     ...
     *
     * @param {NewscatcherApi.GetAggregationCountRequest} request
     * @param {AggregationCountClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<NewscatcherApi.GetAggregationCountResponse> {
    ...
    private async __get(
        request: NewscatcherApi.GetAggregationCountRequest,
        requestOptions?: AggregationCountClient.RequestOptions,
    ): Promise<core.WithRawResponse<NewscatcherApi.GetAggregationCountResponse>> {
        const {
            q,
        ...
        if (_response.ok) {
            return {
                data: _response.body as NewscatcherApi.GetAggregationCountResponse,
     ...
     * Retrieves the count of articles aggregated by day or hour based on various search criteria, such as keyword, language, country, and source.
     *
     * @param {NewscatcherApi.PostAggregationCountRequest} request
     * @param {AggregationCountClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NewscatcherApi.BadRequestError}
     * @throws {@link NewscatcherApi.UnauthorizedError}
    ...
    public post(
        ...
        requestOptions?: AggregationCountClient.RequestOptions,
    ): core.HttpResponsePromise<NewscatcherApi.PostAggregationCountResponse> {
    ...
    private async __post(
        request: NewscatcherApi.PostAggregationCountRequest,
        requestOptions?: AggregationCountClient.RequestOptions,
    ): Promise<core.WithRawResponse<NewscatcherApi.PostAggregationCountResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as NewscatcherApi.PostAggregationCountResponse,
                rawResponse: _response.rawResponse,
            };
        }
