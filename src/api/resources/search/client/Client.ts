...
export class SearchClient {
     ...
     *
     * @param {NewscatcherApi.GetSearchRequest} request
    ...
    ): core.HttpResponsePromise<NewscatcherApi.GetSearchResponse> {
    ...
    private async __get(
        request: NewscatcherApi.GetSearchRequest,
        requestOptions?: SearchClient.RequestOptions,
    ): Promise<core.WithRawResponse<NewscatcherApi.GetSearchResponse>> {
        const {
            q,
            search_in: searchIn,
        ...
        if (_response.ok) {
            return { data: _response.body as NewscatcherApi.GetSearchResponse, rawResponse: _response.rawResponse };
        }
     ...
     * Searches for articles based on specified criteria such as keywords, language, country, source, and more.
     *
     * @param {NewscatcherApi.PostSearchRequest} request
     * @param {SearchClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NewscatcherApi.BadRequestError}
     * @throws {@link NewscatcherApi.UnauthorizedError}
    ...
    public post(
        ...
        requestOptions?: SearchClient.RequestOptions,
    ): core.HttpResponsePromise<NewscatcherApi.PostSearchResponse> {
    ...
    private async __post(
        request: NewscatcherApi.PostSearchRequest,
        requestOptions?: SearchClient.RequestOptions,
    ): Promise<core.WithRawResponse<NewscatcherApi.PostSearchResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NewscatcherApi.PostSearchResponse, rawResponse: _response.rawResponse };
        }
