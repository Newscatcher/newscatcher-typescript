...
export interface AggregationGetRequest {
     ...
     */
    from_?: NewscatcherApi.AggregationGetRequestFrom;
    /**
     ...
     * **Note**: By default, applied to the publication date of the article. To use the article's parse date instead, set the `by_parse_date` parameter to `true`.
     */
    to_?: NewscatcherApi.AggregationGetRequestTo;
    /**
     ...
     */
    published_date_precision?: NewscatcherApi.AggregationGetRequestPublishedDatePrecision;
     ...
     */
    sort_by?: NewscatcherApi.AggregationGetRequestSortBy;
