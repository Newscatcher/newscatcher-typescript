...
export class SearchByLinkClient {
     ...
     *
     * @param {NewscatcherApi.SearchByLinkGetRequest} request
    ...
    public searchByLinkGet(
        ...
        return core.HttpResponsePromise.fromPromise(this.__searchByLinkGet(request, requestOptions));
    }

    private async __searchByLinkGet(
        request: NewscatcherApi.SearchByLinkGetRequest = {},
        requestOptions?: SearchByLinkClient.RequestOptions,
     ...
     *
     * @param {NewscatcherApi.SearchByLinkPostRequest} request
     * @param {SearchByLinkClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NewscatcherApi.BadRequestError}
     * @throws {@link NewscatcherApi.UnauthorizedError}
     ...
     *     })
     */
    public searchByLinkPost(
        request: NewscatcherApi.SearchByLinkPostRequest = {},
        requestOptions?: SearchByLinkClient.RequestOptions,
    ): core.HttpResponsePromise<NewscatcherApi.SearchResponseDto> {
        return core.HttpResponsePromise.fromPromise(this.__searchByLinkPost(request, requestOptions));
    }

    private async __searchByLinkPost(
        request: NewscatcherApi.SearchByLinkPostRequest = {},
        requestOptions?: SearchByLinkClient.RequestOptions,
    ): Promise<core.WithRawResponse<NewscatcherApi.SearchResponseDto>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
