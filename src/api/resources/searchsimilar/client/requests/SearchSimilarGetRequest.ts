...
export interface SearchSimilarGetRequest {
     ...
     */
    from_?: NewscatcherApi.SearchSimilarGetRequestFrom;
    /**
     ...
     * **Note**: By default, applied to the publication date of the article. To use the article's parse date instead, set the `by_parse_date` parameter to `true`.
     */
    to_?: NewscatcherApi.SearchSimilarGetRequestTo;
     ...
     */
    published_date_precision?: NewscatcherApi.SearchSimilarGetRequestPublishedDatePrecision;
    /**
     ...
     */
    sort_by?: NewscatcherApi.SearchSimilarGetRequestSortBy;
