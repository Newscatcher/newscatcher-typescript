...
export interface AuthorsGetRequest {
     ...
     */
    from_?: NewscatcherApi.AuthorsGetRequestFrom;
    /**
     ...
     * **Note**: By default, applied to the publication date of the article. To use the article's parse date instead, set the `by_parse_date` parameter to `true`.
     */
    to_?: NewscatcherApi.AuthorsGetRequestTo;
    /**
     ...
     */
    published_date_precision?: NewscatcherApi.AuthorsGetRequestPublishedDatePrecision;
     ...
     */
    sort_by?: NewscatcherApi.AuthorsGetRequestSortBy;
