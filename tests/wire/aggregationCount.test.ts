...
describe("AggregationCountClient", () => {
    test("get (1)", async () => {
        ...
        const response = await client.aggregationCount.get({
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.aggregationCount.get({
                q: "q",
            });
    ...
    test("post (1)", async () => {
        ...
        const response = await client.aggregationCount.post({
            q: '"supply chain" AND Amazon NOT China',
            aggregation_by: "day",
        });
        expect(response).toEqual({
    ...
    test("post (2)", async () => {
        ...
        await expect(async () => {
            return await client.aggregationCount.post({
                q: "q",
            });
        }).rejects.toThrow(NewscatcherApi.BadRequestError);
    });
