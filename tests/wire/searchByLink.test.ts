...
describe("SearchByLinkClient", () => {
    test("get (1)", async () => {
        ...
        const response = await client.searchByLink.get({
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.searchByLink.get();
    ...
    test("post (1)", async () => {
        ...
        const response = await client.searchByLink.post({
            links: "https://www.reuters.com/business/energy/oil-prices-up-after-israeli-attacks-oversupply-caps-gains-2025-09-10/",
        });
        expect(response).toEqual({
            status: "status",
    ...
    test("post (2)", async () => {
        ...
        await expect(async () => {
            return await client.searchByLink.post();
        }).rejects.toThrow(NewscatcherApi.BadRequestError);
    });
